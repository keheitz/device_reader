...
class DeviceTest < ActiveSupport::TestCase
    ...
    test "device cumulative count sums cached reading counts" do
        readings = [{:timestamp=>"2022-11-17T03:21:14Z", :count=>1}, {:timestamp=>"2022-11-17T03:21:25Z", :count=>4}, {:timestamp=>"2022-11-17T03:21:34Z", :count=>5}]
    ...
    test "duplicate payloads should be ignored" do
        readings = [{:timestamp=>"2022-11-17T03:21:14Z", :count=>1}, {:timestamp=>"2022-11-17T03:21:25Z", :count=>4}, {:timestamp=>"2022-11-17T03:21:34Z", :count=>5}]
        readings_2 = [{:timestamp=>"2022-10-17T03:21:14Z", :count=>2}, {:timestamp=>"2022-09-17T03:21:25Z", :count=>3}]
        device = Device.new("2fc45040-8ccb-4ed8-9a8e-42bc3472883a")
